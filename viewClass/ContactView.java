...
public class ContactView {
    ...
    public void start() {
        ...
        System.out.println("3 ✏️  Update Contact");
        System.out.println("4 🗑️  Delete Contact");
        System.out.println("5 📜  Display All Contacts");
        System.out.println("6 👥  Manage Groups");
        System.out.println("7 ⭐  Manage Favorites");
        System.out.println("8 📩  Sync Contacts to Email");
        System.out.println("9 🔎  Search Contacts");
        System.out.println("10 🚫  Block Contact");
        System.out.println("11 ✅  Unblock Contact");
        System.out.println("12 🚫  Display Blocked Contacts");
        ...
        System.out.println("---------------------------------");
            ...
            switch (choice) {
                ...
                case 7:
                      ...
                      break;
                case 8:
                    contactController.syncContactsToEmail(userId);
                    break;
                case 9:
                ...
                case 11:
                      ...
                      break;
                case 12:
                      contactController.displayBlockedContacts(userId);
                      break;
                case 13:
    ...
    private void updateContact(Scanner scanner) {
       try{
        ...
        boolean updated = contactController.updateContact(contactId,userId, firstName, surname, phone, email, profilePicture, contactType, companyName);
    ...
    private void deleteContact(Scanner scanner) {
        ...
        boolean deleted = contactController.deleteContact(contactId,userId);
        if (deleted) {
    ...
    contactController.searchContacts(searchTerm, userId);
   }
   private void blockContact(Scanner scanner){
        System.out.println("Enter blocked contact:");
                      int blockId = scanner.nextInt();
                      contactController.blockContact(blockId,userId);   
                      }
private void unBlockContact(Scanner scanner) {
    System.out.print("Enter contact ID to unblock: ");
    int blockId = scanner.nextInt(); 
    contactController.unBlockContact(blockId, userId);
}
